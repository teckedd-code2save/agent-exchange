    ...
    <div className="min-h-screen flex bg-gray-950 text-gray-100">
      <aside className="w-56 bg-gray-900 border-r border-gray-800 p-4 flex flex-col gap-1 shrink-0">
        ...
        <div className="px-2 py-1 mb-3 bg-red-900/20 border border-red-800/40 rounded-md">
          <p className="text-xs text-red-400 font-semibold">Admin Console</p>
        </div>
        ...
        <div className="mt-auto pt-4 border-t border-gray-800">
          ...
          <Link href="/marketplace" className="px-3 py-2 rounded-md text-xs text-gray-500 hover:text-gray-300 transition-colors block">Discovery</Link>
        </div>
      </aside>
